...
const steps = [
  ...
  },
  {
    ...
    metricLabel: "signals",
    span: "col-span-1",
    bg: "bg-[#0F1117] border border-[#333849]",
  },
];
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#0F1117] text-[#E8E4D9]">
      ...
      <main className="relative">
        ...
        <section className="relative min-h-[100dvh] overflow-hidden px-4 pt-24 sm:px-6 lg:px-8 flex items-center">
          <div className="absolute inset-0 z-0">
            <img
              ...
              aria-hidden
            />
            <div className="absolute inset-0 bg-gradient-to-b from-[#0A0B0E]/50 via-[#0A0B0E]/80 to-[#0A0B0E]" />
          ...
          <div className="relative z-10 mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-10 pb-16 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            >
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                <Button
                  asChild
                  variant="outline"
                  className="h-12 rounded-lg border border-[#333849] bg-transparent px-6 text-[15px] font-medium text-[#E8E4D9] hover:bg-[#1C2030] hover:text-white hover:-translate-y-[1px] transition-transform active:scale-[0.98]"
                >
            ...
            >
              ...
              <div className="relative rounded-[20px] bg-[#0F1117]/90 px-5 py-6 sm:px-8 sm:py-8 border border-white/5 overflow-hidden flex flex-col h-full">
                {/* Header */}
                ...
                <div className="space-y-4 mb-8">
                  <div className="rounded-xl bg-[#1C2030] p-4 sm:p-5 border border-[#333849]/60 shadow-lg mr-4 sm:mr-8 relative group hover:border-[#333849] transition-colors">
                  ...
                  <div className="rounded-xl bg-[#0A0B0E] p-4 sm:p-5 border border-[#333849]/60 shadow-lg ml-4 sm:ml-8 relative group hover:border-[#333849] transition-colors">
                    <div className="absolute -left-[17px] top-1/2 -translate-y-1/2 w-4 h-[2px] bg-[#333849]/50 hidden sm:block group-hover:bg-[#D97757] transition-colors" />
                  ...
                  <div className="rounded-xl bg-gradient-to-br from-[#D97757]/10 to-[#1C2030]/20 p-4 sm:p-5 border border-[#D97757]/30 shadow-[0_0_20px_rgba(217,119,87,0.05)] hover:border-[#D97757]/60 transition-colors">
        ...
        <section className="relative overflow-hidden bg-[#0F1117] px-4 py-32 sm:px-6 lg:px-8 border-t border-[#1C2030]">
                ...
                {steps.map((step, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Node circle desktop */}
                      <div className="hidden lg:flex absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 h-4 w-4 rounded-full bg-[#0F1117] border-2 border-[#D97757] items-center justify-center shadow-[0_0_20px_#D97757] group-hover:bg-[#D97757] group-hover:scale-[1.7] transition-all duration-500 z-20">
                         <div className="h-1.5 w-1.5 rounded-full bg-[#D97757] group-hover:bg-white transition-colors" />
                      </div>

                      {/* Content Mobile */}
                      <div className="block lg:hidden">
                        <p className="nova-mono text-[3.5rem] leading-[0.8] font-bold text-[#1C2030] group-hover:text-[#D97757]/30 transition-colors duration-500 mb-6">
                          0{index + 1}
                        </p>
                      ...
                      <div className={`hidden lg:flex flex-col w-full h-[50%] px-2 transition-transform duration-500 group-hover:-translate-y-3 ${isTop ? 'justify-end pb-12' : 'mt-auto justify-start pt-12'}`}>
                        <div className="relative z-10">
                          <p className={`nova-mono text-[6rem] leading-[0.75] font-bold text-[#1C2030] group-hover:text-[#D97757]/20 transition-colors duration-500 absolute -z-10 ${isTop ? '-bottom-4 -left-4' : '-top-12 -left-4'}`}>
                            0{index + 1}
                          </p>
        ...
        <section className="px-4 py-24 sm:px-6 lg:px-8 border-y border-[#1C2030] bg-[#0A0B0E]">
                ...
                {journey.map((item, index) => (
                  <motion.article key={item.phase} variants={itemVariants} className="relative group">
                    <div className="flex flex-col sm:flex-row items-start gap-6 sm:gap-10">
                      ...
                      {/* The Hub Node */}
                      <div className="relative shrink-0 flex items-center justify-center h-16 w-16 rounded-[12px] border border-[#333849] bg-[#1C2030] z-10 group-hover:border-[#D97757] transition-colors duration-500 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)]">
                        {/* Glow Core */}
                        ...
                        {index !== journey.length - 1 && (
                          <div className="absolute top-[63px] -bottom-[4rem] sm:-bottom-[6rem] left-1/2 -translate-x-1/2 w-px bg-[linear-gradient(to_bottom,#D97757_0%,#333849_30%,#333849_70%,#D97757_100%)] opacity-50 group-hover:opacity-100 transition-opacity duration-500" />
                        )}
                      ...
                      <div className="flex-1 sm:pt-2">
                        <div className="flex items-center gap-4 mb-4">
                           ...
                           <div className="h-px flex-1 bg-gradient-to-r from-[#333849] to-transparent group-hover:from-[#D97757]/30 transition-colors duration-500" />
                        </div>
                        ...
                        <div className="mt-8 flex flex-wrap gap-3">
                          {item.items.map((line) => (
                            <div key={line} className="flex items-center gap-2 rounded-[8px] border border-[#333849] bg-[#1C2030] px-4 py-2.5 transition-colors duration-500 group-hover:border-[#D97757]/40">
        ...
        <section className="px-4 py-24 sm:px-6 lg:px-8">
          <div className="mx-auto grid max-w-6xl grid-cols-1 overflow-hidden rounded-[20px] border border-[#333849] bg-[#1C2030] lg:grid-cols-[1fr_1.2fr]">
            <div className="flex flex-col justify-center p-8 sm:p-12 lg:p-16">
              ...
              <div className="mt-10">
                <Button
                  asChild
                  className="h-12 rounded-lg bg-white px-6 text-[15px] font-medium text-[#0F1117] hover:bg-white/90 hover:-translate-y-[1px] transition-transform active:scale-[0.98]"
                >
                  <Link to="/arena/about-us">Meet the builders</Link>
                </Button>
              </div>
            </div>
            <div className="relative min-h-[300px] lg:min-h-[450px] bg-[#0F1117] border-t lg:border-t-0 lg:border-l border-[#333849]">
              <img
                ...
                loading="lazy"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#0F1117] via-transparent to-[#1C2030]/20" />
            </div>
          </div>
        </section>
      </main>
