          ...
          <div className="relative z-10 mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-10 pb-16 lg:grid-cols-[1.05fr_0.95fr]">
            ...
            >
              ...
              <div className="mt-6 sm:mt-8 flex flex-col gap-3 sm:flex-row">
                <Button
                  asChild
                  className="h-11 sm:h-12 rounded-lg bg-[#D97757] hover:bg-[#E08567] text-white font-medium px-6 text-sm sm:text-[15px] shadow-[0_0_25px_rgba(217,119,87,0.55)] hover:shadow-[0_0_35px_rgba(217,119,87,0.8)] border border-[#E89278]/40 hover:-translate-y-[1px] transition-all active:scale-[0.98]"
                >
